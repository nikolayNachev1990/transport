...
const env = loadConfig(
  {
    ...
    UPLOAD_KAFKA_GROUP: { required: true, description: "Kafka consumer group name" },
    UPLOAD_KAFKA_GROUP_ID: { required: false, description: "Kafka consumer groupId override" },
  },
  process.env,
);
...
export default async function brokerConfig(): Promise<BrokerConfig> {
  return {
    group: env.UPLOAD_KAFKA_GROUP,
    groupId: env.UPLOAD_KAFKA_GROUP_ID,
