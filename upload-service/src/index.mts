// App bootstrap: connect to this service's own Postgres + S3-compatible
// storage + Kafka, then start the HTTP server (which scans src/**/rest/*
// itself — see config/server.mts).
