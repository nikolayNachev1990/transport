...
const rest: RestDefinition = {
  ...
  middlewares: [
    (req, res, next) => {
      ...
      passport.authenticate("google", {
        callbackURL,
        failureRedirect: "/api/google/login/failed/expo",
        session: false,
  ...
  entryPoint: async (req, res) => {
    ...
    const expoRedirectUrl = getGoogleRedirectUrl("/expo");
    ...
    try {
      ...
      console.log("[google/callback/expo] error:", error);
