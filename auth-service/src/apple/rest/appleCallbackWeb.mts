...
const rest: RestDefinition = {
  ...
  middlewares: [
    (req, res, next) => {
      const callbackURL = getAppleCallbackURL("/web");
      passport.authenticate("apple", {
        callbackURL,
        failureRedirect: "/api/apple/login/failed/web",
        session: false,
  ...
  entryPoint: async (req, res) => {
    ...
    const webRedirectUrl = getAppleRedirectUrl("/web");
    ...
    try {
      ...
      console.log("[apple/callback/web] error:", error);
