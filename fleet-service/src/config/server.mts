...
// Same scan-by-convention loader as every other service's server.mts —
// each src/**/rest/*.mts file default-exports a RestDefinition, collected
// here keyed by filename.
